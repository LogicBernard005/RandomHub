// Q16) Class 'Bank' has a method for each of the following:
...
//       1. Entertheinformation(name,address,accountnumber,balance)ofthe depositors. Number of depositors is to be entered by the user.
//       2. Print the information of any depositor.
//       3. Add some amount to the account of any depositor and then display
//          final information of that depositor.
//       4. Removesomeamountfromtheaccountofany.
...
class Bank{
    ...
    // Display info and balance of the depositor 
    ...
    // Withdraw some amount fromt balace deposited 
...
public class Q16{
    public static void main(String [] args){
        ...
        System.out.print("\n Enter the depositor you want to view: ");
        ...
        System.out.print("Enter the depositor number you want to change the address for: ");
        scanner.nextLine(); // Consume newline
